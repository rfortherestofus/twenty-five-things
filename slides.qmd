...
# Automate all the Things  {.inverse background-image="assets/automate.jpg" background-opacity="0.5"}
...
## Use R to Work With Rendered Files {.inverse}
...
# Use AI to Write Better Code  {.inverse background-image="assets/ai-write-code.jpg" background-opacity="0.5"}
...
## Give AI Access to Your Data {.inverse}
...
# Use AI for Data Analysis  {.inverse background-image="assets/ai-analysis.jpg" background-opacity="0.5"}
...
# Join the Community {.inverse background-image="assets/community.jpg" background-opacity="0.5"}
