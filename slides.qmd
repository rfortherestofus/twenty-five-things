...
include-in-header:
  - text: |
      <link rel = "shortcut icon" href = "rru-logo-blue.svg" />
editor_options: 
...
![](assets/googlesheets4.png){.shadow .rounded fig-align="center"}



---

![](assets/google-form-v2.png){.r-stretch .shadow .rounded fig-align="center"}


---

![](assets/google-sheet-v2.png){.r-stretch .shadow .rounded fig-align="center"}
...
![](assets/qualtrics-package.png){.shadow .rounded .r-stretch fig-align="center"}
...
![](assets/tidycensus.png){.shadow .rounded fig-align="center"}
...
::: {.center-slide}
![](assets/largest-communities-oregon.png){.shadow .rounded fig-align="center"}
:::

---

![](/assets/census-bureau-website.png){.shadow .rounded .r-stretch fig-align="center"}
...
![](assets/httr2.png){.shadow .rounded fig-align="center"}


---

![](/assets/dashboard.png){.shadow .rounded fig-align="center"}
...
![](assets/rvest.png){.shadow .rounded fig-align="center"}

---

![](/assets/world-cup-finals.png){.shadow .rounded .r-stretch fig-align="center"}
...
## Make Your Own ggplot Theme {.inverse}
...
![](assets/sf.png){.shadow .rounded fig-align="center"}
...
### Which Elementary Schools in Portland are Within One Mile of a Public Library? {.center-slide}
...
![](assets/mapgl.png){.shadow .rounded fig-align="center"}
...
![](https://posit-dev.github.io/brand-yml/logos/wide/brand-yml-wide-color.png){fig-align="center"}
...
![](assets/netlify.png){.shadow .rounded fig-align="center"}


---

![](assets/netlify-connect-github.png){.shadow .rounded fig-align="center"}

---

![](assets/netlify-deploy.png){.shadow .rounded fig-align="center"}
...
![](assets/typst.png){.shadow .rounded fig-align="center"}

---

![](assets/typst-report.png){.shadow .rounded fig-align="center"}
...
![](assets/gmailr.png){.shadow .rounded fig-align="center"}
...
![](assets/blastula.png){.shadow .rounded fig-align="center"}
...
![](assets/fs.png){.shadow .rounded fig-align="center"}

---

![](assets/zip-package.png){.shadow .rounded fig-align="center"}

---

![](assets/googledrive.png){.shadow .rounded fig-align="center"}
...
# pdftools::pdf_subset(input = "/Users/davidkeyes/Documents/Work/clients/TFFF/OBTN/OBTN 2024.pdf",
#                      output = here::here("assets/obtn-subset.pdf"),
#                      pages = c(1, 18:21, 113:114))
# 
# rfortherestofus::pdf_to_gif(pdf_location = here::here("assets/obtn-subset.pdf"),
#                             gif_file_path = "assets",
#                             gif_file_name = "obtn.gif")
```

![](assets/obtn-pages.png){.shadow .rounded fig-align="center"}
...
![](assets/gh-copilot.png){.shadow .rounded fig-align="center"}
...
![](assets/windsurf.png){.shadow .rounded fig-align="center"}
...
![](assets/gander.png){.shadow .rounded fig-align="center"}
...
![](assets/mall.png){.shadow .rounded fig-align="center"}
...
![](assets/ellmer.png){.shadow .rounded fig-align="center"}
