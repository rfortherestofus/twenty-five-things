...
## Work with API packages: qualtrics {.inverse}
...
## Work with API packages: tidycensus {.inverse}
...
## Work with APIs directly with {httr2} {.inverse}
...
## Scrape data with {rvest} {.inverse}
...
## 11. Make interactive maps {.inverse}
...
## 12. Make wide range of outputs with Quarto {.inverse}
...
## 14. Publish websites online with Netlify {.inverse}
